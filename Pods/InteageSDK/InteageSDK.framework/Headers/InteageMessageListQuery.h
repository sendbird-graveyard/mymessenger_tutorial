...
/**
 *  Class used to retrieve a number of previous or next messages based on a timestamp. This class is not used directly, but instead [`queryMessageListInChannel:`](./Inteage.html#//api/name/queryMessageListInChannel:) of [`Inteage`](./Inteage.html) must be used to creat instances.
 */
@interface InteageMessageListQuery : NSObject

- (id) initWithInteageClient:(InteageClient *)client andChannelUrl:(NSString *)channelUrl;
 ...
 *  @param onResult  Callback invoked upon successful retrieval. queryResult is an array of [`InteageMessageModel`](./InteageMessageModel.html)
