...
//  InteageFramework
//
//  Created by Inteage Developers on 2015. 7. 30..
...
/**
 *  Class used for user memtions. This class is returned as an object when mentionUpdated callback is invoked from [`registerNotificationHandlerMessagingChannelUpdatedBlock:mentionUpdatedBlock:`](./Inteage.html#//api/name/registerNotificationHandlerMessagingChannelUpdatedBlock:mentionUpdatedBlock:) of [`Inteage`](./Inteage.html)
 */
@interface InteageMention : NSObject
