//
//  InteageMessageModel.h
//  InteageFramework
//
//  Created by Inteage Developers on 2015. 4. 24..
...
/**
 *  Is a super class of [`InteageMessage`](./InteageMessage.html), [`InteageBroadcastMessage`](./InteageBroadcastMessage.html), [`InteageFileLink`](./InteageFileLink.html), [`InteageChannel`](./InteageChannel.html)
 */
@interface InteageMessageModel : NSObject
 ...
 *
 *  @return `InteageMessageModel` object made from message in JSON String format
 */
+ (InteageMessageModel *) parseData:(NSString *)data isPresent:(BOOL)present;
